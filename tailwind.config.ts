    ...
    extend: {
      ...
      keyframes: {
        ...
        'orbit-1': {
          ...
          '40%': { transform: 'translate(40%, -30%)' },
          '60%': { transform: 'translate(-50%, -20%)' },
          '80%': { transform: 'translate(-60%, 30%)' },
          '100%': { transform: 'translate(-30%, 60%)' },
        },
        'orbit-2': {
          '0%': { transform: 'translate(50%, -20%)' },
          '20%': { transform: 'translate(-40%, -40%)' },
          '40%': { transform: 'translate(-60%, 30%)' },
          '60%': { transform: 'translate(30%, 60%)' },
          '70%': { transform: 'translate(60%, 20%)' },
      ...
      animation: {
        ...
        'orbit-1': 'orbit-1 50s linear infinite',
