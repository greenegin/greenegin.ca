        ...
        {/* Animated Buttons */}
          <div className="absolute inset-0 z-10">
              <Link
                  ...
                  className="absolute w-32 h-32 md:w-48 md:h-48 rounded-full overflow-hidden cursor-pointer animate-float-complex-1"
                  style={{
                      left: '10%',
                      top: '20%',
              ...
              <Link
                  ...
                  className="absolute w-32 h-32 md:w-48 md:h-48 rounded-full overflow-hidden cursor-pointer animate-float-complex-2"
                  style={{
                      right: '15%',
                      bottom: '25%',
                      animationDuration: '70s',
